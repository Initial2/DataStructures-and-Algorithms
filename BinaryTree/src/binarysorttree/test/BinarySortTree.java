...
class BinarySortTreeTest {
    ...
    public void test() {
        ...
        binarySortTree.addNode(new Node(7));
        binarySortTree.addNode(new Node(3));
        binarySortTree.addNode(new Node(10));
        binarySortTree.addNode(new Node(12));
        binarySortTree.addNode(new Node(5));
        binarySortTree.addNode(new Node(1));
        binarySortTree.addNode(new Node(9));
